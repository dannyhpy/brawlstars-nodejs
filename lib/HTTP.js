...
class HTTP {
  ...
  async getRanking(type, country = 'global') {
    if (!["clubs", "players"].includes(type)) throw "Invalid type, try: clubs or players"
    return await this.requestAsync(`rankings/${country}/${type}`)
  }
